...
; window.wheelzoom = (function(){
    ...
    var main = function(img, options){
        ...
        function onwheel(e){
            ...
            // Calculate the image offset if need be.
            var offsetX = 0;
            var offsetY = 0;
            ...
            if (e.zoomAt){
                offsetX = e.zoomAt.x;
                offsetY = e.zoomAt.y;
                zoom = 0.35; // A larger zoom factor so the user clicks less.
            }
            else {
                ...
                offsetX = e.pageX - rect.left - document.body.scrollLeft;
                offsetY = e.pageY - rect.top - document.body.scrollTop;
            }
